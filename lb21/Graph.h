...
Graph operator * ( Graph G1, Graph G2)
{
    ...
    {
        for (set<unsigned>::iterator it1=G2.v.begin(); it1!=G2.v.end(); ++it)
        {
            if (*it==*it1)
            {
                result.v.insert(*it);
    ...
    {
        for (multimap<unsigned,unsigned>::iterator it1=G2.e.begin(); it1!=G2.e.end(); ++it)
        {
...
Graph operator - ( Graph G1, Graph G2) {
    ...
    for(set<unsigned>::iterator it=G2.v.begin(); it!=G2.v.end(); ++it) 
    {
        for(set<unsigned>::iterator ti=G2.v.begin(); ti!=G2.v.end(); ++ti) 
        {
            if ((*it)==(*ti)) 
            {
                t.insert(*it);
